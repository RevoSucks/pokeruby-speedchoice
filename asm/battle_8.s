...
dp01t_00_7_getattr: @ 8033524
	...
	sub sp, 0x100
	movs r6, 0
	ldr r1, _08033550 @ =BattleBufferA
...
sub_8033598: @ 8033598
	...
	lsrs r5, r0, 24
	movs r6, 0
	ldr r2, _080335CC @ =BattleBufferA
...
dp01t_01_2_read_pokmon_data_slice: @ 8033D44
	...
	adds r4, r2, 0
	muls r4, r0
	ldr r3, _08033DC4 @ =BattleBufferA
	lsls r1, 9
	adds r0, r3, 0x1
	adds r0, r1, r0
	ldrb r2, [r0]
...
dp01t_02_7_setattr: @ 8033DCC
	push {r4,r5,lr}
	ldr r1, _08033DF0 @ =BattleBufferA
...
_0803417C:
	...
	adds r0, r1
	ldr r3, _08034198 @ =BattleBufferA
	ldrb r2, [r6]
	lsls r2, 9
	adds r1, r3, 0x1
	adds r1, r2, r1
...
_08034204:
	...
	adds r0, r1
	ldr r3, _08034228 @ =BattleBufferA
	ldrb r2, [r6]
	lsls r2, 9
	adds r1, r3, 0x1
	adds r1, r2, r1
...
sub_8034744: @ 8034744
	...
	adds r3, r1, 0
	muls r3, r0
	ldr r4, _080347B0 @ =BattleBufferA
	lsls r2, 9
	adds r0, r4, 0x1
	adds r0, r2, r0
	ldrb r0, [r0]
...
sub_8034910: @ 8034910
	...
	lsls r2, r0, 1
	adds r2, r1
	ldr r3, _08034950 @ =BattleBufferA
	lsls r0, 9
	adds r1, r3, 0x1
	adds r0, r1
	ldrb r0, [r0]
...
sub_803495C: @ 803495C
	...
	lsls r4, r6, 1
	adds r4, r0
	ldr r0, _08034ABC @ =BattleBufferA
	lsls r1, r6, 9
	adds r0, 0x1
	adds r1, r0
	ldrb r0, [r1]
...
sub_8034AE0: @ 8034AE0
	push {r4-r6,lr}
	ldr r1, _08034B10 @ =BattleBufferA
...
sub_8035104: @ 8035104
	...
	b _08035226
_08035116:
	ldr r0, _080351EC @ =BattleBufferA
	mov r12, r0
	ldrb r2, [r6]
	lsls r2, 9
	adds r0, 0x1
...
sub_8035238: @ 8035238
	...
	mov r6, r8
	push {r6,r7}
	ldr r2, _0803527C @ =BattleBufferA
...
sub_80356CC: @ 80356CC
	...
	ldr r3, _08035744 @ =BattleBufferA
...
sub_803583C: @ 803583C
	...
	cmp r0, 0
	bne _0803588C
	ldr r4, _08035898 @ =BattleBufferA
	ldrb r3, [r5]
	lsls r3, 9
	adds r0, r4, 0x1
	adds r0, r3, r0
...
sub_803592C: @ 803592C
	...
	ldr r1, _0803595C @ =BattleBufferA
...
sub_8035A20: @ 8035A20
	...
	movs r3, 0xC0
_08035A34:
	ldr r2, _08035A60 @ =BattleBufferA
	ldrb r1, [r4]
	lsls r1, 9
	adds r0, r2, 0x1
	adds r0, r1, r0
...
_08035A60: .4byte BattleBufferA
	thumb_func_end sub_8035A20

	thumb_func_start sub_8035A64
sub_8035A64: @ 8035A64
	push {lr}
	ldr r2, _08035A8C @ =BattleBufferA
...
dp01t_2E_7_battle_intro: @ 8035AD0
	push {lr}
	ldr r1, _08035AF8 @ =BattleBufferA
...
sub_8035C44: @ 8035C44
	...
	beq _08035CB0
_08035C7E:
	ldr r0, _08035CA8 @ =BattleBufferA
	ldrb r1, [r7]
	lsls r2, r1, 9
	adds r0, 0x1
	adds r2, r0
...
_08035CA8: .4byte BattleBufferA
_08035CAC: .4byte gBattlePartyID
_08035CB0:
	ldr r4, _08035D14 @ =BattleBufferA
	ldrb r0, [r7]
	lsls r1, r0, 9
	adds r4, 0x1
	adds r1, r4
...
dp01t_30_7_0803D67C: @ 8035D28
	push {r4-r6,lr}
	ldr r1, _08035D50 @ =BattleBufferA
...
_08035D58:
	...
	orrs r1, r2
	strb r1, [r0]
	ldr r1, _08035DB0 @ =BattleBufferA
	ldrb r2, [r3]
	lsls r0, r2, 9
	adds r1, 0x2
	adds r0, r1
...
sub_8035EC4: @ 8035EC4
	...
	lsls r2, 2
	adds r2, r3
	ldr r0, _08035F20 @ =BattleBufferA
	lsls r1, 9
	adds r0, 0x1
	adds r1, r0
	adds r2, 0x3E
...
dp01t_34_7_move_anim_start_t3: @ 8035F24
	...
	cmp r0, 0
	bne _08035F7C
	ldr r5, _08035F6C @ =BattleBufferA
	ldrb r2, [r6]
	lsls r1, r2, 9
	adds r0, r5, 0x1
	adds r0, r1, r0
