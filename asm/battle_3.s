...
sub_8015894: @ 8015894
	...
	ldr r1, _080159B0 @ =BattleBufferB
...
_080159EE:
	...
	lsrs r6, r0, 24
_08015A36:
	ldr r0, _08015A90 @ =BattleBufferB
	ldrb r2, [r5]
	lsls r1, r2, 9
	adds r0, 0x2
	adds r1, r0
...
sub_8015C90: @ 8015C90
	...
	ldr r2, _08015D10 @ =BattleBufferB
	ldrb r1, [r5]
	lsls r1, 9
	adds r2, 0x3
	adds r1, r2
...
_08015D14:
	...
	lsrs r0, 24
	bl GetBankByPlayerAI
	ldr r2, _08015D34 @ =BattleBufferB
	ldrb r1, [r5]
	lsls r1, 9
	adds r2, 0x3
	adds r1, r2
