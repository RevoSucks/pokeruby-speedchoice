...
_080124A8:
	...
	ldrb r1, [r0]
	ldr r0, _080124C4 @ =BattleBufferB
	ldrb r2, [r0, 0x1]
	ldrb r0, [r0, 0x2]
	lsls r0, 8
	orrs r2, r0
...
_080124F6:
	...
	adds r2, r5, r2
	ldr r1, _08012530 @ =BattleBufferB
	lsls r0, r5, 9
	adds r1, 0x1
	adds r0, r1
	ldrb r0, [r0]
...
_0801256C:
	...
	adds r2, r1, r0
	adds r2, r3
	ldr r0, _080125CC @ =BattleBufferB
	lsls r1, 9
	adds r0, 0x3
	adds r1, r0
	ldrb r0, [r1]
...
_08012968:
	...
	cmp r0, 0x8
	bne _080129A8
	ldr r0, _08012998 @ =BattleBufferB
...
_080129A8:
	...
	cmp r0, 0
	beq _08012A14
	ldr r0, _080129F4 @ =BattleBufferB
...
_08012A80:
	...
	.4byte _08012D94
_08012AA8:
	ldr r0, _08012AC8 @ =BattleBufferB
	mov r1, r8
	ldrb r4, [r1]
	lsls r1, r4, 9
	adds r2, r0, 0x1
...
_08012BB0:
	ldr r2, _08012BD8 @ =BattleBufferB
...
_08012D2C:
	ldr r2, _08012D50 @ =BattleBufferB
...
sub_80147A0: @ 80147A0
	...
	ldr r2, _08014824 @ =BattleBufferB
	ldrb r1, [r4]
	lsls r1, 9
	adds r0, r2, 0x1
	adds r0, r1, r0
...
sub_8014DF8: @ 8014DF8
	...
	ldr r2, _08014E80 @ =BattleBufferB
	ldrb r0, [r3]
	lsls r0, 9
	adds r1, r2, 0x1
	adds r0, r1
