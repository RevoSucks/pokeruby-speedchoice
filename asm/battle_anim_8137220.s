...
sub_813726C: @ 813726C
	...
	cmp r1, 0
	beq _081372B8
	ldr r0, _081372AC @ =BattleBufferA
	lsls r1, r3, 9
	adds r1, r0
	ldrb r0, [r1]
	cmp r0, 0x38
...
dp01_tbl5_exec_completed: @ 813796C
	...
	ldr r1, _081379BC @ =BattleBufferA
	ldrb r0, [r4]
	lsls r0, 9
	adds r0, r1
	movs r1, 0x38
...
dp01t_00_5_getattr: @ 8137A10
	...
	sub sp, 0x100
	movs r6, 0
	ldr r1, _08137A3C @ =BattleBufferA
...
sub_8137A84: @ 8137A84
	...
	lsrs r5, r0, 24
	movs r6, 0
	ldr r2, _08137AB8 @ =BattleBufferA
...
sub_813823C: @ 813823C
	push {r4,r5,lr}
	ldr r1, _08138260 @ =BattleBufferA
...
_081385F8:
	...
	adds r0, r1
	ldr r3, _08138618 @ =BattleBufferA
...
_08138684:
	...
	adds r0, r1
	ldr r3, _081386AC @ =BattleBufferA
...
sub_8138CB4: @ 8138CB4
	push {r4-r6,lr}
	ldr r0, _08138CE0 @ =BattleBufferA
...
sub_8138F44: @ 8138F44
	push {r4,r5,lr}
	ldr r1, _08138F88 @ =BattleBufferA
...
sub_8138FAC: @ 8138FAC
	push {r4-r6,lr}
	ldr r0, _08139080 @ =BattleBufferA
	mov r12, r0
...
sub_81390D0: @ 81390D0
	...
	mov r7, r8
	push {r7}
	ldr r2, _0813910C @ =BattleBufferA
...
sub_8139444: @ 8139444
	...
	ldr r3, _081394BC @ =BattleBufferA
...
sub_8139680: @ 8139680
	push {lr}
	ldr r2, _081396A8 @ =BattleBufferA
...
sub_81396B0: @ 81396B0
	push {lr}
	ldr r2, _081396D8 @ =BattleBufferA
...
dp01t_2E_5_battle_intro: @ 813971C
	push {lr}
	ldr r1, _08139744 @ =BattleBufferA
...
sub_81398BC: @ 81398BC
	...
	lsls r2, r6, 1
	adds r2, r0
	ldr r0, _08139A08 @ =BattleBufferA
	lsls r1, r6, 9
	adds r0, 0x1
	adds r1, r0
	ldrb r0, [r1]
...
_08139A50:
	...
	ldrh r0, [r1, 0x8]
	strb r0, [r4]
	ldr r0, _08139A90 @ =BattleBufferA
	ldrb r1, [r4]
	lsls r2, r1, 9
	adds r0, 0x1
	adds r2, r0
...
sub_8139AA0: @ 8139AA0
	push {r4,r5,lr}
	ldr r1, _08139AC8 @ =BattleBufferA
...
sub_8139B44: @ 8139B44
	push {r4-r6,lr}
	sub sp, 0x4
	ldr r5, _08139B7C @ =BattleBufferA
...
sub_8139BB8: @ 8139BB8
	...
	ldr r1, _08139C00 @ =BattleBufferA
