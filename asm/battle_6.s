...
dp01t_00_1_getattr: @ 802E4D0
	...
	sub sp, 0x100
	movs r6, 0
	ldr r1, _0802E4FC @ =BattleBufferA
...
dp01_getattr_by_ch1_for_player_pokemon_: @ 802E544
	...
	lsrs r5, r0, 24
	movs r6, 0
	ldr r2, _0802E578 @ =BattleBufferA
...
sub_802ECF0: @ 802ECF0
	...
	adds r4, r2, 0
	muls r4, r0
	ldr r3, _0802ED70 @ =BattleBufferA
	lsls r1, 9
	adds r0, r3, 0x1
	adds r0, r1, r0
	ldrb r2, [r0]
...
dp01t_02_1_setattr: @ 802ED78
	push {r4,r5,lr}
	ldr r1, _0802ED9C @ =BattleBufferA
...
_0802F134:
	...
	adds r0, r1
	ldr r3, _0802F154 @ =BattleBufferA
...
_0802F1C0:
	...
	adds r0, r1
	ldr r3, _0802F1E8 @ =BattleBufferA
...
sub_802F7CC: @ 802F7CC
	...
	adds r3, r1, 0
	muls r3, r0
	ldr r4, _0802F838 @ =BattleBufferA
	lsls r2, 9
	adds r0, r4, 0x1
	adds r0, r2, r0
	ldrb r0, [r0]
...
sub_802F8A8: @ 802F8A8
	...
	ldrb r0, [r5]
	ldr r4, _0802F918 @ =BattleBufferA
	lsls r1, r0, 9
	adds r6, r4, 0x2
	adds r1, r6
	ldrb r1, [r1]
...
sub_802F934: @ 802F934
	...
	lsls r2, r6, 1
	adds r2, r0
	ldr r0, _0802FA7C @ =BattleBufferA
	lsls r1, r6, 9
	adds r0, 0x1
	adds r1, r0
	ldrb r0, [r1]
...
sub_802FAA0: @ 802FAA0
	push {r4-r6,lr}
	ldr r1, _0802FAD0 @ =BattleBufferA
...
sub_802FFD0: @ 802FFD0
	push {r4,r5,lr}
	ldr r1, _08030014 @ =BattleBufferA
...
sub_803002C: @ 803002C
	push {lr}
	ldr r1, _08030054 @ =BattleBufferA
...
dp01t_0F_1_move_anim: @ 803005C
	...
	b _0803017E
_0803006E:
	ldr r0, _08030144 @ =BattleBufferA
	mov r12, r0
	ldrb r2, [r6]
	lsls r2, 9
	adds r0, 0x1
...
sub_8030190: @ 8030190
	...
	mov r6, r8
	push {r6,r7}
	ldr r2, _080301D4 @ =BattleBufferA
...
sub_80304A8: @ 80304A8
	...
	movs r1, 0
	bl sub_802E3B4
	ldr r1, _08030524 @ =BattleBufferA
	ldrb r0, [r4]
	lsls r0, 9
	adds r1, 0x2
	adds r0, r1
...
sub_8030530: @ 8030530
	...
	ldr r4, _08030590 @ =BattleBufferA
_0803055E:
	adds r0, r3, r5
	ldrb r1, [r2]
	lsls r1, 9
...
sub_8030594: @ 8030594
	...
	lsls r1, 3
	adds r1, r4
	ldr r4, _08030654 @ =BattleBufferA
	lsls r2, 9
	adds r3, r4, 0x1
	adds r2, r3
	ldrb r2, [r2]
...
sub_8030698: @ 8030698
	...
	ldr r3, _08030710 @ =BattleBufferA
...
sub_8030798: @ 8030798
	push {r4-r7,lr}
	ldr r5, _080307C4 @ =BattleBufferA
...
sub_80308A8: @ 80308A8
	...
	cmp r0, 0
	bne _080308F8
	ldr r4, _08030904 @ =BattleBufferA
	ldrb r3, [r5]
	lsls r3, 9
	adds r0, r4, 0x1
	adds r0, r3, r0
...
sub_8030910: @ 8030910
	...
	movs r1, 0x37
	bl GetMonData
	ldr r2, _08030978 @ =BattleBufferA
	ldrb r1, [r4]
	lsls r1, 9
	adds r2, 0x1
	adds r1, r2
...
sub_8030988: @ 8030988
	push {r4,r5,lr}
	ldr r3, _080309EC @ =BattleBufferA
...
sub_8030A3C: @ 8030A3C
	push {lr}
	ldr r2, _08030A64 @ =BattleBufferA
...
sub_8030AE4: @ 8030AE4
	...
	ldr r1, _08030B14 @ =BattleBufferA
...
sub_8030BD8: @ 8030BD8
	...
	movs r3, 0xC0
_08030BEC:
	ldr r2, _08030C18 @ =BattleBufferA
	ldrb r1, [r4]
	lsls r1, 9
	adds r0, r2, 0x1
	adds r0, r1, r0
...
_08030C18: .4byte BattleBufferA
	thumb_func_end sub_8030BD8

	thumb_func_start sub_8030C1C
sub_8030C1C: @ 8030C1C
	push {lr}
	ldr r2, _08030C44 @ =BattleBufferA
...
dp01t_2E_1_battle_intro: @ 8030C8C
	push {lr}
	ldr r1, _08030CB4 @ =BattleBufferA
...
_08030ECC:
	...
	beq _08030F1C
_08030EEC:
	ldr r0, _08030F14 @ =BattleBufferA
	ldrb r1, [r7]
	lsls r2, r1, 9
	adds r0, 0x1
	adds r2, r0
...
_08030F14: .4byte BattleBufferA
_08030F18: .4byte gBattlePartyID
_08030F1C:
	ldr r4, _08030F94 @ =BattleBufferA
	ldrb r0, [r7]
	lsls r1, r0, 9
	adds r4, 0x1
	adds r1, r4
...
sub_8030FAC: @ 8030FAC
	push {r4-r6,lr}
	ldr r1, _08030FD4 @ =BattleBufferA
...
dp01t_33_1_enemy_move: @ 8031114
	...
	lsls r2, 2
	adds r2, r3
	ldr r0, _08031170 @ =BattleBufferA
	lsls r1, 9
	adds r0, 0x1
	adds r1, r0
	adds r2, 0x3E
...
bx_exec_buffer_A_ch0_tbl1: @ 8031174
	...
	cmp r0, 0
	bne _080311CC
	ldr r5, _080311BC @ =BattleBufferA
	ldrb r2, [r6]
	lsls r1, r2, 9
	adds r0, r5, 0x1
	adds r0, r1, r0
...
dp01t_35_1_link_standby_message_and_free_vram: @ 80311DC
	push {r4,lr}
	ldr r1, _080311FC @ =BattleBufferA
...
sub_8031238: @ 8031238
	push {r4,lr}
	ldr r1, _08031258 @ =BattleBufferA
...
sub_80312A0: @ 80312A0
	...
	ldr r1, _080312DC @ =BattleBufferA
