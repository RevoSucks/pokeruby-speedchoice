...
dp01t_00_4_getattr: @ 803807C
	...
	sub sp, 0x100
	movs r6, 0
	ldr r1, _080380A8 @ =BattleBufferA
...
dp01_getattr_by_ch1_for_player_pokemon__: @ 80380F0
	...
	lsrs r5, r0, 24
	movs r6, 0
	ldr r2, _08038124 @ =BattleBufferA
...
sub_80388A8: @ 80388A8
	push {r4,r5,lr}
	ldr r1, _080388CC @ =BattleBufferA
...
_08038C58:
	...
	adds r0, r1
	ldr r3, _08038C74 @ =BattleBufferA
	ldrb r2, [r6]
	lsls r2, 9
	adds r1, r3, 0x1
	adds r1, r2, r1
...
_08038CE0:
	...
	adds r0, r1
	ldr r3, _08038D04 @ =BattleBufferA
	ldrb r2, [r6]
	lsls r2, 9
	adds r1, r3, 0x1
	adds r1, r2, r1
...
sub_8039220: @ 8039220
	...
	adds r3, r1, 0
	muls r3, r0
	ldr r4, _0803928C @ =BattleBufferA
	lsls r2, 9
	adds r0, r4, 0x1
	adds r0, r2, r0
	ldrb r0, [r0]
...
sub_80393E4: @ 80393E4
	...
	lsls r2, r0, 1
	adds r2, r1
	ldr r3, _08039424 @ =BattleBufferA
	lsls r0, 9
	adds r1, r3, 0x1
	adds r0, r1
	ldrb r0, [r0]
...
sub_8039430: @ 8039430
	...
	lsls r4, r6, 1
	adds r4, r0
	ldr r0, _08039590 @ =BattleBufferA
	lsls r1, r6, 9
	adds r0, 0x1
	adds r1, r0
	ldrb r0, [r1]
...
sub_80395B4: @ 80395B4
	push {r4-r6,lr}
	ldr r1, _080395E4 @ =BattleBufferA
...
sub_8039A30: @ 8039A30
	...
	b _08039B52
_08039A42:
	ldr r0, _08039B18 @ =BattleBufferA
	mov r12, r0
	ldrb r2, [r6]
	lsls r2, 9
	adds r0, 0x1
...
sub_8039B64: @ 8039B64
	...
	mov r6, r8
	push {r6,r7}
	ldr r2, _08039BA8 @ =BattleBufferA
...
sub_8039D80: @ 8039D80
	...
	ldr r3, _08039DF8 @ =BattleBufferA
...
sub_8039EF0: @ 8039EF0
	...
	cmp r0, 0
	bne _08039F40
	ldr r4, _08039F4C @ =BattleBufferA
	ldrb r3, [r5]
	lsls r3, 9
	adds r0, r4, 0x1
	adds r0, r3, r0
...
sub_8039FE0: @ 8039FE0
	...
	ldr r1, _0803A010 @ =BattleBufferA
...
sub_803A0D4: @ 803A0D4
	...
	movs r3, 0xC0
_0803A0E8:
	ldr r2, _0803A114 @ =BattleBufferA
	ldrb r1, [r4]
	lsls r1, 9
	adds r0, r2, 0x1
	adds r0, r1, r0
...
_0803A114: .4byte BattleBufferA
	thumb_func_end sub_803A0D4

	thumb_func_start sub_803A118
sub_803A118: @ 803A118
	push {lr}
	ldr r2, _0803A140 @ =BattleBufferA
...
dp01t_2E_4_battle_intro: @ 803A184
	push {lr}
	ldr r1, _0803A1AC @ =BattleBufferA
...
sub_803A2C4: @ 803A2C4
	...
	beq _0803A330
_0803A2FE:
	ldr r0, _0803A328 @ =BattleBufferA
	ldrb r1, [r7]
	lsls r2, r1, 9
	adds r0, 0x1
	adds r2, r0
...
_0803A328: .4byte BattleBufferA
_0803A32C: .4byte gBattlePartyID
_0803A330:
	ldr r4, _0803A394 @ =BattleBufferA
	ldrb r0, [r7]
	lsls r1, r0, 9
	adds r4, 0x1
	adds r1, r4
...
sub_803A3DC: @ 803A3DC
	push {r4-r6,lr}
	ldr r1, _0803A404 @ =BattleBufferA
...
_0803A40C:
	...
	orrs r1, r2
	strb r1, [r0]
	ldr r1, _0803A464 @ =BattleBufferA
	ldrb r2, [r3]
	lsls r0, r2, 9
	adds r1, 0x2
	adds r0, r1
...
sub_803A578: @ 803A578
	...
	lsls r2, 2
	adds r2, r3
	ldr r0, _0803A5D4 @ =BattleBufferA
	lsls r1, 9
	adds r0, 0x1
	adds r1, r0
	adds r2, 0x3E
...
bx_exec_buffer_A_ch0_tbl4: @ 803A5D8
	...
	cmp r0, 0
	bne _0803A630
	ldr r5, _0803A620 @ =BattleBufferA
	ldrb r2, [r6]
	lsls r1, r2, 9
	adds r0, r5, 0x1
	adds r0, r1, r0
...
sub_803A658: @ 803A658
	push {lr}
	ldr r1, _0803A674 @ =BattleBufferA
