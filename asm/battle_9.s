...
_08036900: .4byte gEnemyParty
	...
	thumb_func_start AI_SwitchingLogic
AI_SwitchingLogic: @ 8036904
	push {r4-r7,lr}
	mov r7, r8
	push {r7}
	sub sp, 0x4
...
_08036AFE:
	...
	pop {r1}
	bx r1
	thumb_func_end AI_SwitchingLogic

	thumb_func_start AI_TrySwitchingAndItems
AI_TrySwitchingAndItems: @ 8036B0C
	push {r4-r6,lr}
...
_08036C48: .4byte gActiveBank
	thumb_func_end AI_TrySwitchingAndItems
...
LinkOpponentBufferRunCommand: @ 803752C
	...
	cmp r1, 0
	beq _08037578
	ldr r0, _0803756C @ =BattleBufferA
	lsls r1, r3, 9
	adds r1, r0
	ldrb r0, [r1]
	cmp r0, 0x38
...
LinkOpponentBufferExecCompleted: @ 8038004
	...
	lsls r0, 2
	adds r0, r1
	ldr r1, _0803804C @ =LinkOpponentBufferRunCommand
	str r1, [r0]
	...
	ldr r1, _08038054 @ =BattleBufferA
	ldrb r0, [r4]
	lsls r0, 9
	adds r0, r1
	movs r1, 0x38
...
_0803804C: .4byte LinkOpponentBufferRunCommand
_08038050: .4byte gBattleTypeFlags
_08038054: .4byte BattleBufferA
_08038058:
