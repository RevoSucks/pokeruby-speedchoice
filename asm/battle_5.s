...
dp01_tbl1_exec_completed: @ 802BF9C
	...
	ldr r1, _0802BFEC @ =BattleBufferA
	ldrb r0, [r4]
	lsls r0, 9
	adds r0, r1
	movs r1, 0x38
...
sub_802C098: @ 802C098
	...
	mov r7, r8
	push {r7}
	ldr r7, _0802C0FC @ =BattleBufferA
...
_0802C720:
	...
	strb r0, [r1]
_0802C73A:
	ldr r3, _0802C76C @ =BattleBufferA
...
_0802DFD0:
	...
	bl dp01_build_cmdbuf_x22_a_three_bytes
_0802DFDA:
	ldr r1, _0802DFFC @ =BattleBufferA
...
sub_802E220: @ 802E220
	push {r4-r6,lr}
	sub sp, 0x4
	ldr r4, _0802E2B8 @ =BattleBufferA
...
sub_802E2D4: @ 802E2D4
	push {r4,r5,lr}
	sub sp, 0x8
	ldr r4, _0802E314 @ =BattleBufferA
