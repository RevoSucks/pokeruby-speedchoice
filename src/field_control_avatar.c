...
static bool32 sub_8068770(void)
{
    if ((FlagGet(BADGE07_GET) || CheckSpeedchoiceOption(AQUALESS, KEEP) == FALSE) && sub_8068F18() == 2)
    {
...
static bool32 sub_80687A4(void)
{
    if ((FlagGet(BADGE07_GET) || CheckSpeedchoiceOption(AQUALESS, KEEP) == FALSE) && gMapHeader.mapType == 5 && sub_8068F18() == 1)
    {
