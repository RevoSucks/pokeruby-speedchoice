...
void LinkPartnerBufferRunCommand(void)
{
    if (gBattleExecBuffer & gBitTable[gActiveBank])
    {
        if (BattleBufferA[gActiveBank][0] <= 0x38)
            gLinkPartnerBufferCommands[BattleBufferA[gActiveBank][0]]();
        else
...
void LinkPartnerBufferExecCompleted(void)
{
    ...
    if (gBattleTypeFlags & 2)
    {
        ...
        BattleBufferA[gActiveBank][0] = 0x38;
    }
    else
    {
...
u32 dp01_getattr_by_ch1_for_player_pokemon(u8 a, u8 *buffer)
{
    ...
    switch (BattleBufferA[gActiveBank][1])
    {
    case 0:
    ...
    case 6:
    case 7:
        data16 = GetMonData(&gPlayerParty[a], MON_DATA_MOVE1 + BattleBufferA[gActiveBank][1] - 4);
        buffer[0] = data16;
        buffer[1] = data16 >> 8;
        size = 2;
        break;
    ...
    case 11:
    case 12:
        buffer[0] = GetMonData(&gPlayerParty[a], MON_DATA_PP1 + BattleBufferA[gActiveBank][1] - 9);
        size = 1;
        break;
    case 17:
...
void LinkPartnerHandleSetAttributes(void)
{
    ...
    {
        r4 = BattleBufferA[gActiveBank][2];
        for (i = 0; i < 6; i++)
        {
            if (r4 & 1)
                sub_811EC68(i);
...
{
    struct BattlePokemon *battlePokemon = (struct BattlePokemon *)&BattleBufferA[gActiveBank][3];
    struct UnknownStruct3 *moveData = (struct UnknownStruct3 *)&BattleBufferA[gActiveBank][3];
    s32 i;
    ...
    case 0:
        ...
        break;
    case 1:
        SetMonData(&gPlayerParty[a], MON_DATA_SPECIES, &BattleBufferA[gActiveBank][3]);
        break;
    case 2:
        SetMonData(&gPlayerParty[a], MON_DATA_HELD_ITEM, &BattleBufferA[gActiveBank][3]);
        break;
    case 3:
        for (i = 0; i < 4; i++)
        {
    ...
    case 6:
    case 7:
        SetMonData(&gPlayerParty[a], MON_DATA_MOVE1 + BattleBufferA[gActiveBank][1] - 4, &BattleBufferA[gActiveBank][3]);
        break;
    case 8:
        SetMonData(&gPlayerParty[a], MON_DATA_PP1, &BattleBufferA[gActiveBank][3]);
        SetMonData(&gPlayerParty[a], MON_DATA_PP2, &BattleBufferA[gActiveBank][4]);
        SetMonData(&gPlayerParty[a], MON_DATA_PP3, &BattleBufferA[gActiveBank][5]);
        SetMonData(&gPlayerParty[a], MON_DATA_PP4, &BattleBufferA[gActiveBank][6]);
        SetMonData(&gPlayerParty[a], MON_DATA_PP_BONUSES, &BattleBufferA[gActiveBank][7]);
        break;
    case 9:
    case 10:
    case 11:
    case 12:
        SetMonData(&gPlayerParty[a], MON_DATA_PP1 + BattleBufferA[gActiveBank][1] - 9, &BattleBufferA[gActiveBank][3]);
        break;
    case 17:
        SetMonData(&gPlayerParty[a], MON_DATA_OT_ID, &BattleBufferA[gActiveBank][3]);
        break;
    case 18:
        SetMonData(&gPlayerParty[a], MON_DATA_EXP, &BattleBufferA[gActiveBank][3]);
        break;
    case 19:
        SetMonData(&gPlayerParty[a], MON_DATA_HP_EV, &BattleBufferA[gActiveBank][3]);
        break;
    case 20:
        SetMonData(&gPlayerParty[a], MON_DATA_ATK_EV, &BattleBufferA[gActiveBank][3]);
        break;
    case 21:
        SetMonData(&gPlayerParty[a], MON_DATA_DEF_EV, &BattleBufferA[gActiveBank][3]);
        break;
    case 22:
        SetMonData(&gPlayerParty[a], MON_DATA_SPD_EV, &BattleBufferA[gActiveBank][3]);
        break;
    case 23:
        SetMonData(&gPlayerParty[a], MON_DATA_SPATK_EV, &BattleBufferA[gActiveBank][3]);
        break;
    case 24:
        SetMonData(&gPlayerParty[a], MON_DATA_SPDEF_EV, &BattleBufferA[gActiveBank][3]);
        break;
    case 25:
        SetMonData(&gPlayerParty[a], MON_DATA_FRIENDSHIP, &BattleBufferA[gActiveBank][3]);
        break;
    case 26:
        SetMonData(&gPlayerParty[a], MON_DATA_POKERUS, &BattleBufferA[gActiveBank][3]);
        break;
    case 27:
        SetMonData(&gPlayerParty[a], MON_DATA_MET_LOCATION, &BattleBufferA[gActiveBank][3]);
        break;
    case 28:
        SetMonData(&gPlayerParty[a], MON_DATA_MET_LEVEL, &BattleBufferA[gActiveBank][3]);
        break;
    case 29:
        SetMonData(&gPlayerParty[a], MON_DATA_MET_GAME, &BattleBufferA[gActiveBank][3]);
        break;
    case 30:
        SetMonData(&gPlayerParty[a], MON_DATA_POKEBALL, &BattleBufferA[gActiveBank][3]);
        break;
    case 31:
        SetMonData(&gPlayerParty[a], MON_DATA_HP_IV, &BattleBufferA[gActiveBank][3]);
        SetMonData(&gPlayerParty[a], MON_DATA_ATK_IV, &BattleBufferA[gActiveBank][4]);
        SetMonData(&gPlayerParty[a], MON_DATA_DEF_IV, &BattleBufferA[gActiveBank][5]);
        SetMonData(&gPlayerParty[a], MON_DATA_SPD_IV, &BattleBufferA[gActiveBank][6]);
        SetMonData(&gPlayerParty[a], MON_DATA_SPATK_IV, &BattleBufferA[gActiveBank][7]);
        SetMonData(&gPlayerParty[a], MON_DATA_SPDEF_IV, &BattleBufferA[gActiveBank][8]);
        break;
    case 32:
        SetMonData(&gPlayerParty[a], MON_DATA_HP_IV, &BattleBufferA[gActiveBank][3]);
        break;
    case 33:
        SetMonData(&gPlayerParty[a], MON_DATA_ATK_IV, &BattleBufferA[gActiveBank][3]);
        break;
    case 34:
        SetMonData(&gPlayerParty[a], MON_DATA_DEF_IV, &BattleBufferA[gActiveBank][3]);
        break;
    case 35:
        SetMonData(&gPlayerParty[a], MON_DATA_SPD_IV, &BattleBufferA[gActiveBank][3]);
        break;
    case 36:
        SetMonData(&gPlayerParty[a], MON_DATA_SPATK_IV, &BattleBufferA[gActiveBank][3]);
        break;
    case 37:
        SetMonData(&gPlayerParty[a], MON_DATA_SPDEF_IV, &BattleBufferA[gActiveBank][3]);
        break;
    case 38:
        SetMonData(&gPlayerParty[a], MON_DATA_PERSONALITY, &BattleBufferA[gActiveBank][3]);
        break;
    case 39:
        SetMonData(&gPlayerParty[a], MON_DATA_CHECKSUM, &BattleBufferA[gActiveBank][3]);
        break;
    case 40:
        SetMonData(&gPlayerParty[a], MON_DATA_STATUS, &BattleBufferA[gActiveBank][3]);
        break;
    case 41:
        SetMonData(&gPlayerParty[a], MON_DATA_LEVEL, &BattleBufferA[gActiveBank][3]);
        break;
    case 42:
        SetMonData(&gPlayerParty[a], MON_DATA_HP, &BattleBufferA[gActiveBank][3]);
        break;
    case 43:
        SetMonData(&gPlayerParty[a], MON_DATA_MAX_HP, &BattleBufferA[gActiveBank][3]);
        break;
    case 44:
        SetMonData(&gPlayerParty[a], MON_DATA_ATK, &BattleBufferA[gActiveBank][3]);
        break;
    case 45:
        SetMonData(&gPlayerParty[a], MON_DATA_DEF, &BattleBufferA[gActiveBank][3]);
        break;
    case 46:
        SetMonData(&gPlayerParty[a], MON_DATA_SPD, &BattleBufferA[gActiveBank][3]);
        break;
    case 47:
        SetMonData(&gPlayerParty[a], MON_DATA_SPATK, &BattleBufferA[gActiveBank][3]);
        break;
    case 48:
        SetMonData(&gPlayerParty[a], MON_DATA_SPDEF, &BattleBufferA[gActiveBank][3]);
        break;
    case 49:
        SetMonData(&gPlayerParty[a], MON_DATA_COOL, &BattleBufferA[gActiveBank][3]);
        break;
    case 50:
        SetMonData(&gPlayerParty[a], MON_DATA_BEAUTY, &BattleBufferA[gActiveBank][3]);
        break;
    case 51:
        SetMonData(&gPlayerParty[a], MON_DATA_CUTE, &BattleBufferA[gActiveBank][3]);
        break;
    case 52:
        SetMonData(&gPlayerParty[a], MON_DATA_SMART, &BattleBufferA[gActiveBank][3]);
        break;
    case 53:
        SetMonData(&gPlayerParty[a], MON_DATA_TOUGH, &BattleBufferA[gActiveBank][3]);
        break;
    case 54:
        SetMonData(&gPlayerParty[a], MON_DATA_SHEEN, &BattleBufferA[gActiveBank][3]);
        break;
    case 55:
        SetMonData(&gPlayerParty[a], MON_DATA_COOL_RIBBON, &BattleBufferA[gActiveBank][3]);
        break;
    case 56:
        SetMonData(&gPlayerParty[a], MON_DATA_BEAUTY_RIBBON, &BattleBufferA[gActiveBank][3]);
        break;
    case 57:
        SetMonData(&gPlayerParty[a], MON_DATA_CUTE_RIBBON, &BattleBufferA[gActiveBank][3]);
        break;
    case 58:
        SetMonData(&gPlayerParty[a], MON_DATA_SMART_RIBBON, &BattleBufferA[gActiveBank][3]);
        break;
    case 59:
        SetMonData(&gPlayerParty[a], MON_DATA_TOUGH_RIBBON, &BattleBufferA[gActiveBank][3]);
        break;
    }
    sub_80324F8(&gPlayerParty[gBattlePartyID[gActiveBank]], gActiveBank);
}
...
void sub_811F664(void)
{
    ...
    dst = (u8 *)&gPlayerParty[gBattlePartyID[gActiveBank]] + BattleBufferA[gActiveBank][1];
    for (i = 0; i < BattleBufferA[gActiveBank][2]; i++)
        dst[i] = BattleBufferA[gActiveBank][3 + i];
    LinkPartnerBufferExecCompleted();
}
...
{
    sub_8032AA8(gActiveBank, BattleBufferA[gActiveBank][2]);
    gBattlePartyID[gActiveBank] = BattleBufferA[gActiveBank][1];
    sub_80318FC(&gPlayerParty[gBattlePartyID[gActiveBank]], gActiveBank);
    sub_811F864(gActiveBank, BattleBufferA[gActiveBank][2]);
...
void sub_811F864(u8 a, u8 b)
{
    ...
    sub_8032AA8(a, b);
    gBattlePartyID[a] = BattleBufferA[a][1];
...
{
    if (BattleBufferA[gActiveBank][1] == 0)
    {
...
void sub_811FDFC(void)
{
    ...
    {
        u32 r0 = BattleBufferA[gActiveBank][1]
               | (BattleBufferA[gActiveBank][2] << 8);

        gUnknown_0202F7C4 = BattleBufferA[gActiveBank][3];
        gMovePowerMoveAnim = BattleBufferA[gActiveBank][4]
                          | (BattleBufferA[gActiveBank][5] << 8);
        gMoveDmgMoveAnim = BattleBufferA[gActiveBank][6]
                          | (BattleBufferA[gActiveBank][7] << 8)
                          | (BattleBufferA[gActiveBank][8] << 16)
                          | (BattleBufferA[gActiveBank][9] << 24);
        gHappinessMoveAnim = BattleBufferA[gActiveBank][10];
        gWeatherMoveAnim = BattleBufferA[gActiveBank][12]
                          | (BattleBufferA[gActiveBank][13] << 8);
        gDisableStructMoveAnim = (u32 *)&BattleBufferA[gActiveBank][16];
...
void sub_811FF30(void)
{
    u16 r4 = BattleBufferA[gActiveBank][1]
           | (BattleBufferA[gActiveBank][2] << 8);
    u8 r7 = BattleBufferA[gActiveBank][11];
    ...
    case 3:
        if (!ewram17810[gActiveBank].unk0_6)
        {
            ...
            sub_80324BC(
              gActiveBank,
              BattleBufferA[gActiveBank][1] | (BattleBufferA[gActiveBank][2] << 8));
            ewram17810[gActiveBank].unk4 = 0;
            LinkPartnerBufferExecCompleted();
        }
        break;
...
void sub_8120094(void)
{
    gUnknown_030042A4 = 0;
    gUnknown_030042A0 = 0;
    BufferStringBattle(*(u16 *)&BattleBufferA[gActiveBank][2]);
...
void LinkPartnerHandleHealthBarUpdate(void)
{
    ...
    r7 = BattleBufferA[gActiveBank][2] | (BattleBufferA[gActiveBank][3] << 8);
    if (r7 != 0x7FFF)
    {
...
void LinkPartnerHandleStatusAnimation(void)
{
    if (mplay_80342A4(gActiveBank) == 0)
    {
        move_anim_start_t2_for_situation(
          BattleBufferA[gActiveBank][1],
          BattleBufferA[gActiveBank][2]
          | (BattleBufferA[gActiveBank][3] << 8)
          | (BattleBufferA[gActiveBank][4] << 16)
          | (BattleBufferA[gActiveBank][5] << 24));
        gBattleBankFunc[gActiveBank] = sub_811E38C;
    }
}
...
{
    gUnknown_020238C8.unk0_0 = BattleBufferA[gActiveBank][1];
    LinkPartnerBufferExecCompleted();
}
...
void LinkPartnerHandleEffectivenessSound(void)
{
    ...
    if (GetBankSide(gActiveBank) == 0)
        ...
        pan = 63;
    PlaySE12WithPanning(BattleBufferA[gActiveBank][1] | (BattleBufferA[gActiveBank][2] << 8), pan);
    LinkPartnerBufferExecCompleted();
}

void sub_81204E4(void)
{
    PlayFanfare(BattleBufferA[gActiveBank][1] | (BattleBufferA[gActiveBank][2] << 8));
    LinkPartnerBufferExecCompleted();
}
...
{
    sub_80E43C0(BattleBufferA[gActiveBank][1]);
    gUnknown_02024DE8 |= 1;
    LinkPartnerBufferExecCompleted();
}
...
void sub_812071C(u8 taskId)
{
    ...
    {
        BattleBufferA[gActiveBank][1] = gBattlePartyID[gActiveBank];
...
{
    if (BattleBufferA[gActiveBank][1] != 0 && GetBankSide(gActiveBank) == 0)
    {
        LinkPartnerBufferExecCompleted();
        return;
    }
    ...
    gUnknown_02024E68[gActiveBank] = sub_8044804(
      gActiveBank,
      (struct BattleInterfaceStruct2 *)&BattleBufferA[gActiveBank][4],
      BattleBufferA[gActiveBank][1],
      BattleBufferA[gActiveBank][2]);
...
void sub_8120978(void)
{
    ...
    {
        gSprites[gObjectBankIDs[gActiveBank]].invisible = BattleBufferA[gActiveBank][1];
        sub_8031F88(gActiveBank);
    }
    LinkPartnerBufferExecCompleted();
}
...
void sub_81209D8(void)
{
    if (mplay_80342A4(gActiveBank) == 0)
    {
        u8 r3 = BattleBufferA[gActiveBank][1];
        u16 r4 = BattleBufferA[gActiveBank][2] | (BattleBufferA[gActiveBank][3] << 8);
        u8 var = gActiveBank;
...
{
    gBattleOutcome = BattleBufferA[gActiveBank][1];
    FadeOutMapMusic(5);
