...
extern void SetBankFuncToSafariBufferRunCommand(void);
extern void SetBankFuncToWallyBufferRunCommand(void);
extern void SetBankFuncToPlayerBufferRunCommand(void);
extern void SetBankFuncToOpponentBufferRunCommand(void);
extern void SetBankFuncToLinkOpponentBufferRunCommand(void);
extern void SetBankFuncToLinkPartnerBufferRunCommand(void);
...
extern u8 AbilityBattleEffects();
    ...
    if (gTasks[taskId].data[15] != gTasks[taskId].data[14])
    {
        ...
        case 0:
            if (gBattleExecBuffer & gBitTable[r4])
                return;
            memcpy(BattleBufferA[r4], &unk_2000000[0x15000 + gTasks[taskId].data[15] + 8], r7);
            sub_80155A4(r4);
            if (!(gBattleTypeFlags & BATTLE_TYPE_WILD))
            {
            ...
            break;
        case 1:
            memcpy(BattleBufferB[r4], &unk_2000000[0x15000 + gTasks[taskId].data[15] + 8], r7);
            break;
        case 2:
...
void EmitBallThrowAnim(u8 a, u8 shakes)
{
    ...
    gBattleBuffersTransferData[1] = shakes;
    dp01_prepare_buffer(a, gBattleBuffersTransferData, 2);
}
...
void EmitDMATransfer(u8 a, u32 b, u16 c, u8 *d) //Unused
{
    int i;
